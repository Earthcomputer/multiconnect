...
object CommonClassNames {
    ...
    const val CLIENT_PACKET_LISTENER = "net.minecraft.client.multiplayer.ClientPacketListener"
    ...
    const val REGISTRY = "net.minecraft.core.Registry"
    const val RESOURCE_KEY = "net.minecraft.resources.ResourceKey"
    const val BLOCK_STATE = "net.minecraft.world.level.block.state.BlockState"
    const val DATA_FIXERS = "net.minecraft.util.datafix.DataFixers"
    const val REFERENCES = "net.minecraft.util.datafix.fixes.References"
