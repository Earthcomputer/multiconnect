...
public class SPacketSynchronizeRecipes_Latest implements SPacketSynchronizeRecipes {
    ...
    public static List<Recipe> computeRecipes(
            @Argument("recipes") List<SPacketSynchronizeRecipes_1_13_2.RecipeWithId> recipes,
            ...
            @FilledArgument(fromVersion = Protocols.V1_13_2, toVersion = Protocols.V1_14) Function<SPacketSynchronizeRecipes_Latest.Ingredient, SPacketSynchronizeRecipes_Latest.Ingredient> ingredientTranslator
    ) {
        return recipes.stream()
                .map(recipe -> {
                    Recipe newRecipe;
                    if (recipe.recipe instanceof SPacketSynchronizeRecipes_1_13_2.CraftingShapeless shapeless) {
                    ...
                    } else if (recipe.recipe instanceof SPacketSynchronizeRecipes_1_13_2.CraftingShaped shaped) {
                        ...
                        newRecipe = newShaped;
                    } else if (recipe.recipe instanceof SPacketSynchronizeRecipes_1_13_2.Smelting smelting) {
