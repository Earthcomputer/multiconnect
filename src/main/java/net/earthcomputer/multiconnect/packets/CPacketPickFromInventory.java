...
import net.earthcomputer.multiconnect.packets.v1_12_2.CPacketCustomPayload_1_12_2.PickItem;

@MessageVariant(minVersion = Protocols.V1_13)
public class CPacketPickFromInventory {
    public int slot;
    ...
    public static CPacketCustomPayload_1_12_2 toCustomPayload(
        ...
        var packet = new CPacketCustomPayload_1_12_2.PickItem();
        packet.channel = "MC|PickItem";
        packet.slot = slot;
        return packet;
    }
}
