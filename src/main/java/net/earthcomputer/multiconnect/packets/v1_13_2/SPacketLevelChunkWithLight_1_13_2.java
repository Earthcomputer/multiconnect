...
public class SPacketLevelChunkWithLight_1_13_2 implements SPacketLevelChunkWithLight {
    @Type(Types.INT)
    public int x;
    @Type(Types.INT)
    public int z;
    ...
    @ReturnType(SPacketLevelChunkWithLight.class)
    @ReturnType(SPacketSetChunkCacheCenter.class)
    @Handler
    public static List<Object> handle(
            @Argument(value = "this", translate = true) SPacketLevelChunkWithLight_1_14_4 translatedThis,
