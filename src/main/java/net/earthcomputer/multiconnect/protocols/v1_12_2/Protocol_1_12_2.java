...
public class Protocol_1_12_2 extends Protocol_1_13 {
    ...
    private void mutateBiomeRegistry(ISimpleRegistry<Biome> registry) {
        rename(registry, BuiltInBiomes.MOUNTAINS, "extreme_hills");
        rename(registry, BuiltInBiomes.SWAMP, "swampland");
        rename(registry, BuiltInBiomes.NETHER_WASTES, "hell");
        rename(registry, BuiltInBiomes.THE_END, "sky");
        rename(registry, BuiltInBiomes.SNOWY_TUNDRA, "ice_flats");
        rename(registry, BuiltInBiomes.SNOWY_MOUNTAINS, "ice_mountains");
        rename(registry, BuiltInBiomes.MUSHROOM_FIELDS, "mushroom_island");
        rename(registry, BuiltInBiomes.MUSHROOM_FIELD_SHORE, "mushroom_island_shore");
        rename(registry, BuiltInBiomes.BEACH, "beaches");
        rename(registry, BuiltInBiomes.WOODED_HILLS, "forest_hills");
        rename(registry, BuiltInBiomes.MOUNTAIN_EDGE, "smaller_extreme_hills");
        rename(registry, BuiltInBiomes.STONE_SHORE, "stone_beach");
        rename(registry, BuiltInBiomes.SNOWY_BEACH, "cold_beach");
        rename(registry, BuiltInBiomes.DARK_FOREST, "roofed_forest");
        rename(registry, BuiltInBiomes.SNOWY_TAIGA, "taiga_cold");
        rename(registry, BuiltInBiomes.SNOWY_TAIGA_HILLS, "taiga_cold_hills");
        rename(registry, BuiltInBiomes.GIANT_TREE_TAIGA, "redwood_taiga");
        rename(registry, BuiltInBiomes.GIANT_TREE_TAIGA_HILLS, "redwood_taiga_hills");
        rename(registry, BuiltInBiomes.WOODED_MOUNTAINS, "extreme_hills_with_trees");
        rename(registry, BuiltInBiomes.SAVANNA_PLATEAU, "savanna_rock");
        rename(registry, BuiltInBiomes.BADLANDS, "mesa");
        rename(registry, BuiltInBiomes.WOODED_BADLANDS_PLATEAU, "mesa_rock");
        rename(registry, BuiltInBiomes.BADLANDS_PLATEAU, "mesa_clear_rock");
        registry.purge(BuiltInBiomes.SMALL_END_ISLANDS);
        registry.purge(BuiltInBiomes.END_MIDLANDS);
        registry.purge(BuiltInBiomes.END_HIGHLANDS);
        registry.purge(BuiltInBiomes.END_BARRENS);
        registry.purge(BuiltInBiomes.WARM_OCEAN);
        registry.purge(BuiltInBiomes.LUKEWARM_OCEAN);
        registry.purge(BuiltInBiomes.COLD_OCEAN);
        registry.purge(BuiltInBiomes.DEEP_WARM_OCEAN);
        registry.purge(BuiltInBiomes.DEEP_LUKEWARM_OCEAN);
        registry.purge(BuiltInBiomes.DEEP_WARM_OCEAN);
        registry.purge(BuiltInBiomes.DEEP_LUKEWARM_OCEAN);
        registry.purge(BuiltInBiomes.DEEP_COLD_OCEAN);
        registry.purge(BuiltInBiomes.DEEP_FROZEN_OCEAN);
        rename(registry, BuiltInBiomes.THE_VOID, "void");
        rename(registry, BuiltInBiomes.SUNFLOWER_PLAINS, "mutated_plains");
        rename(registry, BuiltInBiomes.DESERT_LAKES, "mutated_desert");
        rename(registry, BuiltInBiomes.GRAVELLY_MOUNTAINS, "mutated_extreme_hills");
        rename(registry, BuiltInBiomes.FLOWER_FOREST, "mutated_forest");
        rename(registry, BuiltInBiomes.TAIGA_MOUNTAINS, "mutated_taiga");
        rename(registry, BuiltInBiomes.SWAMP_HILLS, "mutated_swampland");
        rename(registry, BuiltInBiomes.ICE_SPIKES, "mutated_ice_flats");
        rename(registry, BuiltInBiomes.MODIFIED_JUNGLE, "mutated_jungle");
        rename(registry, BuiltInBiomes.MODIFIED_JUNGLE_EDGE, "mutated_jungle_edge");
        rename(registry, BuiltInBiomes.TALL_BIRCH_FOREST, "mutated_birch_forest");
        rename(registry, BuiltInBiomes.TALL_BIRCH_HILLS, "mutated_birch_forest_hills");
        rename(registry, BuiltInBiomes.DARK_FOREST_HILLS, "mutated_roofed_forest_hills");
        rename(registry, BuiltInBiomes.SNOWY_TAIGA_MOUNTAINS, "mutated_taiga_cold");
        rename(registry, BuiltInBiomes.GIANT_SPRUCE_TAIGA, "mutated_redwood_taiga");
        rename(registry, BuiltInBiomes.GIANT_SPRUCE_TAIGA_HILLS, "mutated_redwood_taiga_hills");
        rename(registry, BuiltInBiomes.MODIFIED_GRAVELLY_MOUNTAINS, "mutated_extreme_hills_with_trees");
        rename(registry, BuiltInBiomes.SHATTERED_SAVANNA, "mutated_savanna");
        rename(registry, BuiltInBiomes.SHATTERED_SAVANNA_PLATEAU, "mutated_savanna_rock");
        rename(registry, BuiltInBiomes.ERODED_BADLANDS, "mutated_mesa");
        rename(registry, BuiltInBiomes.MODIFIED_WOODED_BADLANDS_PLATEAU, "mutated_mesa_rock");
        rename(registry, BuiltInBiomes.MODIFIED_BADLANDS_PLATEAU, "mutated_mesa_clear_rock");
    }
