...
//    private void cancelInteractBlockPacket(ClientPlayNetworkHandler connection, Packet<?> packet) {
...
//                connection.sendPacket(new PlayerInteractBlockC2SPacket(hand, hitResult));
//            }
//        }
//    }
//
