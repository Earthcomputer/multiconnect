...
public class Blocks_1_12_2 {
    public static final Block FLOWING_WATER = new OldLiquidBlock(Fluids.FLOWING_WATER, Blocks.WATER);
    public static final Block FLOWING_LAVA = new OldLiquidBlock(Fluids.FLOWING_LAVA, Blocks.LAVA);
